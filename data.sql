...
INSERT INTO tbproducts ("FK_category", "name", "urlProduct", "regularPrice", "offerPrice", "stock", "description")
VALUES 
    (1, 'Nike Air Max 270', 'nike-air-max-270', 129.99, NULL, 50, 'Zapatillas Nike Air Max 270 para hombres'),
    (1, 'Adidas Ultraboost 21', 'adidas-ultraboost-21', 159.99, NULL, 35, 'Zapatillas Adidas Ultraboost 21 para hombres'),
    (1, 'New Balance Fresh Foam X', 'new-balance-fresh-foam-x', 119.99, 99.99, 20, 'Zapatillas New Balance Fresh Foam X para hombres'),
    (2, 'Nike Air Zoom Pegasus 38', 'nike-air-zoom-pegasus-38', 119.99, NULL, 45, 'Zapatillas Nike Air Zoom Pegasus 38 para mujeres'),
    (2, 'Adidas Ultraboost 21 W', 'adidas-ultraboost-21-w', 159.99, NULL, 30, 'Zapatillas Adidas Ultraboost 21 para mujeres'),
    (2, 'Reebok Nano X', 'reebok-nano-x', 99.99, 79.99, 25, 'Zapatillas Reebok Nano X para mujeres'),
    (3, 'Nike Revolution 5 GS', 'nike-revolution-5-gs', 59.99, NULL, 60, 'Zapatillas Nike Revolution 5 para niños'),
    (3, 'Adidas Duramo SL K', 'adidas-duramo-sl-k', 49.99, NULL, 40, 'Zapatillas Adidas Duramo SL para niños'),
    (3, 'Puma Vikky v2', 'puma-vikky-v2', 44.99, 34.99, 30, 'Zapatillas Puma Vikky v2 para niños'),
    (4, 'Nike Air Zoom Structure 24', 'nike-air-zoom-structure-24', 139.99, NULL, 35, 'Zapatillas Nike Air Zoom Structure 24 para running'),
    (4, 'Asics Gel-Kayano 28', 'asics-gel-kayano-28', 169.99, NULL, 25, 'Zapatillas Asics Gel-Kayano 28 para running'),
    (4, 'Brooks Adrenaline GTS 23', 'brooks-adrenaline-gts-23', 129.99, 109.99, 30, 'Zapatillas Brooks Adrenaline GTS 23 para running'),
    (5, 'Nike Zoom Freak 3', 'nike-zoom-freak-3', 119.99, NULL, 40, 'Zapatillas Nike Zoom Freak 3 para basketball'),
    (5, 'Adidas Dame 7', 'adidas-dame-7', 129.99, NULL, 30, 'Zapatillas Adidas Dame 7 para basketball'),
    (5, 'Under Armour Curry 8', 'under-armour-curry-8', 159.99, NULL, 20, 'Zapatillas Under Armour Curry 8 para basketball'),
    (6, 'Converse Chuck Taylor All Star', 'converse-chuck-taylor-all-star', 59.99, NULL, 50, 'Zapatillas Converse Chuck Taylor All Star casuales'),
    (6, 'Vans Old Skool', 'vans-old-skool', 69.99, NULL, 40, 'Zapatillas Vans Old Skool casuales'),
    (6, 'Adidas Stan Smith', 'adidas-stan-smith', 79.99, NULL, 35, 'Zapatillas Adidas Stan Smith casuales'),
    (7, 'Nike Metcon 7', 'nike-metcon-7', 129.99, NULL, 30, 'Zapatillas Nike Metcon 7 para entrenamiento'),
    (7, 'Reebok Nano X1', 'reebok-nano-x1', 119.99, NULL, 25, 'Zapatillas Reebok Nano X1 para entrenamiento'),
    (7, 'New Balance Minimus Prevail', 'new-balance-minimus-prevail', 109.99, NULL, 20, 'Zapatillas New Balance Minimus Prevail para entrenamiento'),
    (8, 'Nike SB Zoom Stefan Janoski', 'nike-sb-zoom-stefan-janoski', 79.99, NULL, 40, 'Zapatillas Nike SB Zoom Stefan Janoski para skate'),
    (8, 'Vans Sk8-Hi', 'vans-sk8-hi', 89.99, NULL, 35, 'Zapatillas Vans Sk8-Hi para skate'),
    (8, 'Adidas Busenitz', 'adidas-busenitz', 99.99, NULL, 30, 'Zapatillas Adidas Busenitz para skate'),
    (9, 'Yeezy Boost 350 V2', 'yeezy-boost-350-v2', 219.99, NULL, 15, 'Zapatillas Yeezy Boost 350 V2 de moda'),
    (9, 'Air Jordan 1 Retro High OG', 'air-jordan-1-retro-high-og', 179.99, NULL, 20, 'Zapatillas Air Jordan 1 Retro High OG de moda'),
    (9, 'Nike Air Force 1', 'nike-air-force-1', 99.99, NULL, 30, 'Zapatillas Nike Air Force 1 de moda'),
    (10, 'Salomon Speedcross 5', 'salomon-speedcross-5', 139.99, NULL, 25, 'Zapatillas Salomon Speedcross 5 para trail running'),
    (10, 'Hoka One One Speedgoat 4', 'hoka-one-one-speedgoat-4', 159.99, NULL, 20, 'Zapatillas Hoka One One Speedgoat 4 para trail running'),
    (10, 'Merrell Moab 2 GTX', 'merrell-moab-2-gtx', 129.99, NULL, 30, 'Zapatillas Merrell Moab 2 GTX para trail running');
...
VALUES 
    ...
    (17, 17, 2, 400.00, 800.00),
    (18, 18, 1, 850.00, 850.00),
    (19, 19, 2, 450.00, 900.00),
    (20, 20, 1, 950.00, 950.00),
    (1, 21, 1, 100.00, 100.00),
    (2, 22, 2, 75.00, 150.00),
    (3, 23, 3, 50.00, 150.00),
    (4, 24, 1, 150.00, 150.00),
    (5, 25, 2, 60.00, 120.00),
    (6, 26, 3, 90.00, 270.00),
    (7, 27, 1, 250.00, 250.00),
    (8, 28, 2, 200.00, 400.00),
    (9, 29, 1, 150.00, 150.00),
    (10, 30, 3, 50.00, 150.00),
    (11, 21, 2, 225.00, 450.00),
    (12, 22, 1, 550.00, 550.00),
    (13, 23, 3, 200.00, 600.00),
    (14, 24, 2, 325.00, 650.00),
    (15, 25, 1, 700.00, 700.00);
...
VALUES
    ...
    (17, 'https://i.pinimg.com/564x/5b/96/88/5b96884eef291d937d0d8aa28babcdfa.jpg'),
    (17, 'https://i.pinimg.com/564x/37/f5/99/37f599aceea19026769a0747e0838f66.jpg'),
    (18, 'https://i.pinimg.com/564x/27/a5/80/27a580f0965bc92ef54efd0355b61335.jpg'),
    (18, 'https://i.pinimg.com/564x/b6/a6/37/b6a63704140dffe9218a21b12e1d7de0.jpg'),
    (19, 'https://i.pinimg.com/736x/94/f8/61/94f861c8bc292b84190a7459fc43a6c0.jpg'),
    (19, 'https://i.pinimg.com/564x/12/70/98/127098fe7552f972c2f88df8000982f6.jpg'),
    (20, 'https://i.pinimg.com/564x/5b/96/88/5b96884eef291d937d0d8aa28babcdfa.jpg'),
    (20, 'https://i.pinimg.com/564x/37/f5/99/37f599aceea19026769a0747e0838f66.jpg'),
    (21, 'https://i.pinimg.com/564x/27/a5/80/27a580f0965bc92ef54efd0355b61335.jpg'),
    (21, 'https://i.pinimg.com/564x/b6/a6/37/b6a63704140dffe9218a21b12e1d7de0.jpg'),
    (22, 'https://i.pinimg.com/736x/94/f8/61/94f861c8bc292b84190a7459fc43a6c0.jpg'),
    (22, 'https://i.pinimg.com/564x/12/70/98/127098fe7552f972c2f88df8000982f6.jpg'),
    (23, 'https://i.pinimg.com/564x/5b/96/88/5b96884eef291d937d0d8aa28babcdfa.jpg'),
    (23, 'https://i.pinimg.com/564x/37/f5/99/37f599aceea19026769a0747e0838f66.jpg'),
    (24, 'https://i.pinimg.com/564x/27/a5/80/27a580f0965bc92ef54efd0355b61335.jpg'),
    (24, 'https://i.pinimg.com/564x/b6/a6/37/b6a63704140dffe9218a21b12e1d7de0.jpg'),
    (25, 'https://i.pinimg.com/736x/94/f8/61/94f861c8bc292b84190a7459fc43a6c0.jpg'),
    (25, 'https://i.pinimg.com/564x/12/70/98/127098fe7552f972c2f88df8000982f6.jpg'),
    (26, 'https://i.pinimg.com/564x/5b/96/88/5b96884eef291d937d0d8aa28babcdfa.jpg'),
    (26, 'https://i.pinimg.com/564x/37/f5/99/37f599aceea19026769a0747e0838f66.jpg'),
    (27, 'https://i.pinimg.com/564x/27/a5/80/27a580f0965bc92ef54efd0355b61335.jpg'),
    (27, 'https://i.pinimg.com/564x/b6/a6/37/b6a63704140dffe9218a21b12e1d7de0.jpg'),
    (28, 'https://i.pinimg.com/736x/94/f8/61/94f861c8bc292b84190a7459fc43a6c0.jpg'),
    (28, 'https://i.pinimg.com/564x/12/70/98/127098fe7552f972c2f88df8000982f6.jpg'),
    (29, 'https://i.pinimg.com/564x/5b/96/88/5b96884eef291d937d0d8aa28babcdfa.jpg'),
    (29, 'https://i.pinimg.com/564x/37/f5/99/37f599aceea19026769a0747e0838f66.jpg'),
    (30, 'https://i.pinimg.com/564x/27/a5/80/27a580f0965bc92ef54efd0355b61335.jpg')
;
